...
function IcoBell({ color }: { color: string }) {
  return (
    <View>
      ...
      <View style={{ position: 'absolute', top: -4, right: -6, backgroundColor: '#F97316', borderRadius: 8, minWidth: 16, height: 16, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 3 }}>
        <Text style={{ fontSize: 9, fontWeight: '800', color: '#FFFFFF' }}>3</Text>
      </View>
    </View>
  );
}
...
function ScannerIcon() {
  return (
    <View style={{ width: 56, height: 56, borderRadius: 28, backgroundColor: '#F97316', alignItems: 'center', justifyContent: 'center', marginBottom: 24, shadowColor: '#F97316', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.5, shadowRadius: 12, elevation: 10 }}>
      <IcoQr />
    </View>
  );
}
...
export default function TabsLayout() {
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
        tabBarStyle: { backgroundColor: '#111111', borderTopColor: '#2A2A2A', borderTopWidth: 1, height: 65, paddingBottom: 8, paddingTop: 6 },
